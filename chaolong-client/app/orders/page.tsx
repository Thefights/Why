                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    {order.status === "preparing" && (
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                        <p className="text-blue-800 font-sans text-sm">
                          Your order is being prepared in our kitchen. Estimated
                          completion: {order.estimatedTime}
                        </p>
                      </div>
                    )}
                    {order.status === "ready" && (
                      <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                        <p className="text-green-800 font-sans text-sm">
                          Your order is ready for pickup! Please come to collect
                          it.
                        </p>
                      </div>
                    )}
                    {order.status === "delivered" && (
                      <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                        <p className="text-green-800 font-sans text-sm">
                          Order delivered successfully. Thank you for choosing
                          Chao Long Co Tham!
                        </p>
                      </div>
                    )}
                    {order.status === "cancelled" && (
                      <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                        <p className="text-red-800 font-sans text-sm">
                          This order has been cancelled. If you have any
