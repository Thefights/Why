...
const reviews = [
  ...
  },
  {
    ...
    avatar: "/hispanic-man-smiling.png",
  },
  {
    id: 3,
    name: "Emily Johnson",
    ...
    avatar: "/smiling-caucasian-woman.png",
  },
  {
    id: 4,
    name: "David Kim",
  ...
  },
  {
    ...
    avatar: "/smiling-african-american-woman.png",
  },
]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="font-sans text-base sm:text-lg max-w-2xl mx-auto text-muted-foreground px-2 sm:px-0">
            Don't just take our word for it - hear from the families and food lovers who make our restaurant their home
            away from home.
          </p>
        </div>
